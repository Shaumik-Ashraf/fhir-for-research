...
-   **Prerequisite:** [Overview \> FHIR for Research](/modules/fhir-from-10000-ft.qmd)
-   [Real-World Use Cases](#/modules/tabular-real-world.qmd)
-   [FHIR to Tabular Data](#/modules/tabular-from-fhir.qmd)
-   [Retrieving and Subsetting Data With FHIR](#/modules/tabular-retrieving-and-subsetting.qmd)

## Using REDCap with FHIR

-   **Prerequisite:** [Overview \> FHIR for Research](/modules/fhir-from-10000-ft.qmd)
-   [Introduction](#/modules/redcap-intro.qmd)
-   [Best Practices Workflow](#/modules/redcap-best-practices.qmd)
-   [Example for a Study](#/modules/redcap-example.qmd)
