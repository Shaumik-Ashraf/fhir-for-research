...
```
cd existing_repo
git remote add origin https://gitlab.mitre.org/fhir-for-research/web.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.mitre.org/fhir-for-research/web/-/settings/integrations)
