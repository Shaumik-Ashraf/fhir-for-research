...
-   **Adverse Event Reporting**: @Wang_Lehmann_Botsis_2021
-   **Clinical Decision Support**: @Jung_Bae_Seong_Oh_Kim_Yi_2022
-   **Clinical Statistics and Analysis**: @Hong_Prodduturi_Wang_Jiang_2017
-   **Cohort Building**:
...
-   **Data Models**:
    ...
    -   @Pfaff_2019
    -   @Jiang_2017b
-   **Environmental Health Using Spatiotemporal Data**: @Xu_Cox_Stillwell_Pfaff_Champion_Ahalt_Fecho_2020
-   **Findable, Accessible, Interoperable, and Resusabe ([FAIR](https://www.go-fair.org/fair-principles/)) Data Principles**: @Sinaci_Nunez_2020
-   **Multi-site Research**: @Garza_2020
-   **Patient-Facing Apps**:
...
-   **SMART on FHIR**:
    ...
    -   @Wagholikar_2017
-   **Social Determinants of Health**: @Watkins_Viernes_Nguyen_Rojas_Mezarina_Silva_Valencia_Borbolla_2020
