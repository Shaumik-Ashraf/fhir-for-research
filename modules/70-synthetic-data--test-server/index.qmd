...
## Logica Sandbox
The easiest option for hosting data is to use a cloud service - no installation is required on your local computer. The other benefits are that registration is free, a common instance can be shared between multiple people, and you don't have to worry about losing everything when you restart your computer.
...
This set of Docker images mirrors the public Logica Sandbox, but can be run locally. If you like the full suite of what Logica provides but either want higher performance or don't want to use a fully public Internet service, this is a good option.

Full instructions are available at [https://github.com/logicahealth/sandbox-community-edition](https://github.com/logicahealth/sandbox-community-edition).
...
For more detail on the HAPI FHIR docker image, see [https://hub.docker.com/r/hapiproject/hapi](https://hub.docker.com/r/hapiproject/hapi).
