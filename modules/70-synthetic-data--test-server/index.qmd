...
This module describes a few options for hosting FHIR data. While the options listed here may not be robust enough to be production capabilities out of the box, they offer the quickest and easiest options for setting up a FHIR server for testing and training. The options on this page often include a set of default patient data which can be used for basic testing, or you can load your own data created by Synthea.
