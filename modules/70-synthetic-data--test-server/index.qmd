...
### Logica Sandbox
This set of Docker images mirrors the Logica Sandbox, but can be run locally. If you like the full suite of what Logica provides but either want higher performance or don't want to use a fully public Internet service, this is a good option.
