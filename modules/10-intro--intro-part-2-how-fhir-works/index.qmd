...
::: callout-important
This is the second part of our introduction to FHIR for research. You should [read Part 1 first](..//10-intro–intro-part-1-what-is-fhir/index.html) if you haven't already.
...
Applying the cake analogy to a Prior Level of Function Profile, we have:
...
This standard communication approach is called an API (short for [Application Program Interface](https://en.wikipedia.org/wiki/API)). As mentioned in Part 1 <!--# Add link to Part 1 -->, FHIR's API uses a \[REST\](https://en.wikipedia.org/wiki/Representational_state_transfer)ful approach, which is a widely used API paradigm throughout the technology industry. More specifics on FHIR's API can be found in the Accessing FHIR Data module. <!--# Add link to module -->
