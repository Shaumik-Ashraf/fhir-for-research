...
A `CapabilityStatement` is a resource that contains metadata about a FHIR server, including what other resources the server hosts and how to access them. Here let's skip the [CapabilityStatment structure table](https://hl7.org/fhir/capability_statement) and look directly at an example:
