...
However, it may be simpler to use Python or R to convert FHIR-formatted data to tabular, and then import this into a different analysis tool like SAS or Stata.
