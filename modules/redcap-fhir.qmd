...
![The CDIS workflow uses FHIR to simplify the process of creating a registry from EHR data. [@Cheng_2021]](images/cheng-fhir-shortcut.png){alt="The CDIS workflow uses FHIR to simplify the process of creating a registry from EHR data. [@Cheng_2021]"}
