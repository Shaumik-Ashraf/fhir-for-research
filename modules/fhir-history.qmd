...
> FHIR uses [the 80/20 rule](http://www.healthintersections.com.au/?p=1924): the core FHIR specification includes data elements if 80% of relevant systems will implement it. The remaining data elements are handled through [FHIR extensions](https://www.hl7.org/fhir/extensibility.html).
