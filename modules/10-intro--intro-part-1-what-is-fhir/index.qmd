...
3.  Understand the major problems that FHIR helps solve in healthcare and research settings
4.  Understand why now is the time that people should start caring about FHIR
:::

<!--# Replace with "Key Points"? We should discuss once the module's content is in place. -->

<!--# FIX Update learning objectives given split into two seaparate pages --MM -->

<!--# Lizzy's suggestions: understand how fhir helps solve the problems; understand the main differences between fhir and other approaches to health data sharing (and then link to the bigger article) -->
...
![Source: [ONC](https://www.healthit.gov/data/quickstats/national-trends-hospital-and-physician-adoption-electronic-health-records)](images/ehr_adoption.png){#fig-ehr-adoption fig-alt="Graph showing trend in hospital and physician EHR adoption form 2008 to 2021. Adoption is between 10 and 20% in 2008, rising to >70% in 2014."}

The ability to exchange data across these EHRs and ancillary systems ("interoperability") has lagged behind their adoption. Improving interoperability remains a key challenge for the the implementers and users of EHRs, including researchers who wish to utilize EHR data in their work. <mark>FHIR is one of the key technologies that enables interoperability of health-related data.</mark>
...
**Interoperability** is "the ability of different information systems, devices and applications (systems) to access, exchange, integrate and cooperatively use data in a coordinated manner, within and across organizational, regional and national boundaries, to provide timely and seamless portability of information and optimize the health of individuals and populations globally." [@interoperability_himss]

The ability to deliver effective healthcare to all depends on the ability to share information and collaborate in providing care. It helps both clinicians and patients, as the former can now deliver safer, more effective patient-centered care and the latter can now access electronic health information to help manage and coordinate their care. [@interoperability_onc]

### Impact of Lack of Interoperability on Stakeholders

**Poor communication across care providers.** Medication discrepancies such as drug omissions during transitions of care and multiple modes of information transmission result in delays in post-acute care services and can lead to adverse events and preventable readmissions. Redundant information collection creates inefficiencies and burden.

**Reliance on patient recall during periods of high stress.** Recall of information can be unreliable, as patients may be unconscious, incapacitated, or otherwise unresponsive or unable to communicate information. This in term increases patient and/or family stress.
