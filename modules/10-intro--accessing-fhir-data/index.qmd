...
::: {.callout-note .column-body .bg-white collapse="true" id="query-dropdown"}
...
<div class="d-xl-flex row justify-content-around g-3">
  ...
  <div class="col-xl-4 mb-2 my-xl-auto">
    <div class="input-group">
      <input type="text" class="form-control form-control-sm" placeholder="URL to FHIR API" aria-label="URL to FHIR API" name="query-base-uri" size="50">
