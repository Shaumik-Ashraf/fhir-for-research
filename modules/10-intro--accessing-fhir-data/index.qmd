...
```{=html}
  <div class="d-xl-flex row justify-content-around g-3">
    <div class="col-xl-4 mb-2 my-xl-auto mx-auto" style="max-width:8rem;">
      <select id="accessing-fhir-data-query-http-verb" class="form-select form-select-sm" aria-label="Select a FHIR Resource" name="query-http-verb">
    ...
    <div class="col-xl-4 mb-2 my-xl-auto">
      <div class="row d-md-flex justify-content-center">
        <div class="col my-auto">
          <input id="accessing-fhir-data-query-base-url" type="text" class="form-control form-control-sm" aria-label="FHIR API URL" name="query-base-url" placeholder="URL to FHIR API" />
        </div>

        <div class="col my-auto">
          <!-- customized 'slash' svg to look nice -->
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-slash" viewBox="0 0 16 16" transform="rotate(-30 0 0) scale(2 2)">
        ...
        <div class="col my-auto">
          <input id="accessing-fhir-data-query-id" type="text" class="form-control form-control-sm" name="query-id" size="4" placeholder="ID" />
        </div>
      </div>
    </div>

    <div class="col-xl-4 mb-2 my-xl-auto mx-2 text-center">
      <button class="btn btn-sm btn-primary" onclick="getPatient()">Run query</button>
    </div>
  </div>
```
