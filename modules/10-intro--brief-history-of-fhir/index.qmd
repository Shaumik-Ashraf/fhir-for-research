...
Before learning about FHIR, an understanding of the standards that came before it is necessary to understand why it was developed. HL7 has been developing standards for the **transfer of healthcare data** since the late 1980s, with three major standards being implemented since then:
...
Each successive standard has been built on the lessons learned from the previous one, resulting in the current version of FHIR today.
